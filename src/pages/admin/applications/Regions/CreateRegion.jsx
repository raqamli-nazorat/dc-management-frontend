...
const CreatePosition = ({ onClose, refetch }) => {
     ...
     const inputCls = 'w-full px-3 py-2.5 rounded-lg text-sm outline-none border transition-colors bg-[var(--bg-base)] text-[var(--text-strong)] placeholder-[var(--text-disabled)] dark:bg-[var(--bg-base)] dark:text-[var(--text-strong)] dark:placeholder-[var(--text-sub)] border-[var(--stroke-sub)] focus:border-[var(--accent-sub)] dark:border-[var(--stroke-soft)]'
               ...
               <div className="relative w-full max-w-[600px] rounded-2xl shadow-2xl bg-[var(--bg-base)] dark:bg-[var(--bg-elevation-1)]">
                    ...
                    <div className="px-7 pb-2 flex flex-col gap-4">
                         ...
                         <div className="flex justify-between items-center">
                              ...
                              >
                                   <span
                                        className={`absolute left-0 top-0.5 w-4 h-4 bg-white rounded-full bg-[var(--bg-base)] shadow transition-transform duration-200 ${form.is_application ? 'translate-x-5' : 'translate-x-0.5'}`}
                                   />
                              </button>
                         </div>
                    </div>
