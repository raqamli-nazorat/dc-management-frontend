...
const CreatePosition = ({ onClose, refetch }) => {
     ...
     const inputCls = 'w-full px-3 py-2.5 rounded-lg text-sm outline-none border transition-colors bg-[var(--bg-elevation-1-alt)] text-[var(--text-strong)] placeholder-[var(--text-disabled)] dark:bg-[var(--bg-base)] dark:text-[var(--text-strong)] dark:placeholder-[var(--text-sub)] border-[var(--stroke-sub)] focus:border-[var(--accent-sub)] dark:border-[var(--stroke-soft)]'
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto modal-scroll py-8 px-4">
               ...
               <div className="relative w-full max-w-[600px] rounded-2xl shadow-2xl bg-[var(--bg-elevation-1-alt)] dark:bg-[var(--bg-elevation-1)]">
                    ...
                    <div className="px-7 py-5 flex items-center justify-end gap-3">
                         <button onClick={onClose} className="flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium transition-colors cursor-pointer text-[var(--text-sub)] hover:bg-[var(--bg-elevation-1-alt)] dark:text-[var(--text-sub)] dark:hover:bg-[var(--bg-elevation-2)]">
                              <FaXmark size={14} />
                              Yopish
                         </button>
                         <button
