        ...
        <div className="flex flex-col justify-start gap-4">
          ...
          <div className="flex items-center gap-5">
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 pr-3 outline-none transition-colors bg-slate-100 border border-[var(--stroke-sub)] text-[var(--text-strong)] placeholder-[var(--text-soft)] dark:bg-[#222323] dark:border-[#292A2A] dark:text-[#FFFFFF] dark:placeholder-[#8E95B5]"
          ...
          <div className="max-h-[80vh] overflow-y-auto rounded-xl">
                  ...
                  >
                    ...
                    <td className='flex justify-end pr-6 py-3' onClick={(e) => e.stopPropagation()}>
                      <button
                        ...
                        className={`relative w-10 h-5 rounded-full transition-colors cursor-pointer ${application?.is_application ? 'bg-[var(--accent-strong)]' : 'bg-[var(--stroke-sub)] dark:bg-[#292A2A]'}`}
                      >
                        <span
            ...
            {applications.length === 0 && (
              <div className="py-16 text-center text-sm text-[var(--text-disabled)] dark:text-[#8E95B5]">Viloyatlar topilmadi</div>
            )}
          </div>
        </div>
      </div>
