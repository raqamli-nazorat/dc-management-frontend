          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className={`${inputBox} shrink-0`}>
                <input ref={timeFromRef} type="time" value={timeFrom || '00:00'} onChange={e => setTimeFrom(e.target.value === '00:00' ? '' : e.target.value)}
                  placeholder="00:00" step="60"
                  className={`w-[52px] text-xs outline-none bg-transparent cursor-pointer [&::-webkit-calendar-picker-indicator]:hidden
                    ${!timeFrom ? 'text-[#B6BCCB] dark:text-[#474848]' : 'text-[#1A1D2E] dark:text-white'}`} />
              ...
              {/* gacha: vaqt */}
              <div className={`${inputBox} shrink-0`}>
                <input ref={timeToRef} type="time" value={timeTo || '00:00'} onChange={e => setTimeTo(e.target.value === '00:00' ? '' : e.target.value)}
                  placeholder="00:00" step="60"
                  className={`w-[52px] text-xs outline-none bg-transparent cursor-pointer [&::-webkit-calendar-picker-indicator]:hidden
                    ${!timeTo ? 'text-[#B6BCCB] dark:text-[#474848]' : 'text-[#1A1D2E] dark:text-white'}`} />
                ...
                <div className="flex items-center gap-2 px-3 py-2.5 rounded-xl border border-[#E2E6F2] dark:border-[#292A2A]
                  ...
                  <input ref={dateRef} type="date" value={form.date} onChange={e => set('date', e.target.value)}
                    className={`flex-1 min-w-0 text-sm outline-none bg-transparent cursor-pointer [&::-webkit-calendar-picker-indicator]:hidden
                      ${!form.date ? '[&::-webkit-datetime-edit]:opacity-0' : 'text-[#1A1D2E] dark:text-white'}`} />
