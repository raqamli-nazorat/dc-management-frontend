...
export default function Sidebar({ forceCollapsed = false, onForceClick }) {
  ...
  const iconBtn = (active) => [
    ...
    active
      ? 'bg-[var(--stroke-sub)] text-[var(--text-strong)] border-[#EEF1F7] dark:bg-[#303131] dark:text-white dark:border-[#474848]'
      : 'text-[var(--text-sub)] border-transparent hover:bg-[var(--stroke-sub)] hover:border-[#EEF1F7] dark:text-[#C2C8E0] dark:hover:bg-[#303131] dark:hover:border-[#474848]',
  ].join(' ')
        ...
        {isCollapsed ? (
          ...
          <>
            ...
            >
              ...
              <span
                className="truncate text-[var(--text-sub)] dark:text-white"
            ...
            <button
              ...
              className="ml-1 flex items-center justify-center w-7 h-7 rounded-md  cursor-pointer shrink-0
                text-[var(--text-sub)] hover:text-[var(--text-strong)] dark:text-[#C2C8E0] dark:hover:text-white"
            >
            ...
            <NavLink
              ...
              className={({ isActive }) => [
                ...
                isActive || location.pathname.includes('analytics')
                  ? 'bg-[var(--stroke-sub)] text-[var(--text-strong)] border-[#EEF1F7] dark:bg-[#303131] dark:text-white dark:border-[#474848]'
                  : 'text-[var(--text-sub)] border-transparent hover:bg-[var(--stroke-sub)] hover:border-[#EEF1F7] dark:text-[#C2C8E0] dark:hover:bg-[#303131] dark:border-transparent',
              ].join(' ')}
            >
              ...
              {isCollapsed ? (
                ...
                <button
                  ...
                  className={[
                    ...
                    active
                      ? 'bg-[var(--stroke-sub)] text-[var(--text-strong)] border-[#EEF1F7] font-semibold dark:bg-[#303131] dark:text-white dark:border-[#474848]'
                      : 'text-[var(--text-sub)] border-transparent hover:bg-[var(--stroke-sub)] hover:text-[var(--text-strong)] hover:border-[#EEF1F7] dark:text-[#C2C8E0] dark:hover:bg-[#303131] dark:hover:text-white dark:hover:border-[#474848]',
                  ].join(' ')}
                >
                    ...
                    return (
                      <NavLink
                        ...
                        className={() => [
                          ...
                          childActive
                            ? 'bg-[var(--bg-elevation-2)] text-[var(--text-strong)] border-[var(--stroke-sub)] font-semibold dark:bg-[#292A2A] dark:text-white! dark:border-[#292A2A]'
                            : 'text-[var(--text-sub)] border-transparent hover:bg-[var(--bg-elevation-2)] hover:text-[var(--text-strong)] hover:border-[var(--stroke-sub)] dark:text-[#C2C8E0]! dark:hover:text-white! dark:hover:bg-[#292A2A] dark:hover:border-[#292A2A]',
                        ].join(' ')}
                      >
                        {child.label}
                      </NavLink>
          ...
          {isCollapsed ? (
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 px-4 py-3 rounded-lg  cursor-pointer
                hover:bg-[var(--stroke-sub)] dark:hover:bg-[#303131]"
            >
              ...
              <div className="min-w-0 flex-1 text-left">
                <p className="text-[13px] font-medium truncate leading-tight text-[var(--text-strong)] dark:text-white">
                  {user?.username}
                </p>
                  ...
                  return (
                    ...
                    >
                      <div className={`w-9 h-9 rounded-xl flex items-center justify-center text-xs font-bold shrink-0
                        ${isActive ? 'bg-[var(--accent-sub)] text-white' : 'bg-[var(--stroke-sub)] text-[var(--text-sub)] dark:bg-[#292A2A] dark:text-[#C2C8E0]'}`}>
                        {user?.username?.[0]?.toUpperCase()}{user?.username?.[1]?.toUpperCase()}
                      </div>
                      <div className="min-w-0 text-left">
                        <p className="text-[13px] font-bold text-[var(--text-strong)] dark:text-white truncate">{user?.username}</p>
              ...
              <div className="px-4 py-3 border-b border-[#F1F3F9] dark:border-[#2A2B2B]">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-[13px] font-medium text-[var(--text-strong)] dark:text-white">
